...
class MainWindow(QMainWindow):
    ...
    def _init_content_stack(self) -> None:
        ...
        # V3.0 Upgrade: Replace legacy CRM with new Account Manager (Fingerprint isolation)
        self.crm_panel = self._create_lazy("ui.account_manager", "AccountManagerWidget")
